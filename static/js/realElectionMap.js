...
d3.json(statesOutlineWithVotes).then(function(votingData) {
    ...
    votingData.features.forEach(function(data) {
        ...
        var candidate = data.properties.voting_data ? data.properties.voting_data[YEAR] : "None";
        //console.log(region);
        var vote_count = data.properties.voting_data ? data.properties.voting_data[YEAR] : "0";
        topCandidate[region] = vote_count;
    });
    ...
    function getColor(state) {
        ...
        switch (true) {
            case winner[2] = "Democrat":
                color = "blue";
                break;
            case winner[2] = "Republican":
                color = "red";
                break;
        };
        return color;
